...
|--------|-----------|-------------|
| [**Apoia (TCC)**](https://github.com/cfmiila/apoia) | Sistema web de apoio a pessoas necessitadas, com funcionalidades sociais e administrativas. | HTML, CSS, JS, MySQL |
| [Gerador de Senha Segura](https://github.com/WesiOliver/gerador-de-senha-segura) | Gera senhas fortes de forma rápida, com interface simples. | HTML, CSS, JS |
| [Encurtador de URLs](https://github.com/WesiOliver/encurtador-urls) | Sistema para encurtar links longos com backend funcional. | Node.js, Express |
| [Sistema de Previsão do Tempo](https://github.com/WesiOliver/projeto-teste-sistema-previsao-tempo) | Consulta o clima de cidades favoritas, com local storage. | HTML, CSS, JS |
| [Site Fan Duuskwood](https://github.com/WesiOliver/site-fan-duuskwood) | Fanpage de jogo com design personalizado. | HTML, CSS, JS |
| [Projeto Escolar - Senai Tech](https://github.com/WesiOliver/projeto-escolar-senai-tech) | Projeto escolar integrado com múltiplas disciplinas. | C++ |
